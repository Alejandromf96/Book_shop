...
#Decorador para restirngir acceso a administradores
...
# Ruta para añadir libros, accesible solo para administradores
...
def add_book():
    ...
    if form.validate_on_submit():
        ...
        if form.image.data:
            ...
            image_file = 'default.jpg'  # Imagen por defecto

        # Crear el nuevo libro con la imagen
        new_book = Book(
            title=form.title.data,
            author=form.author.data,
            price=form.price.data,
            image_file=image_file  # Guardar el nombre de la imagen
        )
